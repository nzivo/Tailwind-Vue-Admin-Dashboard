...
const menuItems = ref(menuGroups);
</script>
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <h3 class="mb-1 font-semibold text-white">Bate Admin Panel</h3>
        <p class="mb-4 text-xs">
          Let's Collaborate on any Vue, React, FastApi and Laravel Project
        </p>
        <a
          href="https://nzivo.github.io/"
          target="_blank"
          rel="nofollow"
